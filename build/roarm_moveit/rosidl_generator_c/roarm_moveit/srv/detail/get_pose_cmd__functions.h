...
#ifndef ROARM_MOVEIT__SRV__DETAIL__GET_POSE_CMD__FUNCTIONS_H_
#define ROARM_MOVEIT__SRV__DETAIL__GET_POSE_CMD__FUNCTIONS_H_
 ...
 * calls
 * roarm_moveit__srv__GetPoseCmd_Request__init().
...
/**
 * It calls
 * roarm_moveit__srv__GetPoseCmd_Request__fini()
 ...
 * roarm_moveit__srv__GetPoseCmd_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * roarm_moveit__srv__GetPoseCmd_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * roarm_moveit__srv__GetPoseCmd_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_roarm_moveit
...
/**
 * It calls
 * roarm_moveit__srv__GetPoseCmd_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_roarm_moveit
...
/**
 * It allocates the memory for the array and calls
 * roarm_moveit__srv__GetPoseCmd_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_roarm_moveit
...
/**
 * It calls
 * roarm_moveit__srv__GetPoseCmd_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * roarm_moveit__srv__GetPoseCmd_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_roarm_moveit
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * roarm_moveit__srv__GetPoseCmd_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_roarm_moveit
...
/**
 * It calls
 * roarm_moveit__srv__GetPoseCmd_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_roarm_moveit
...
/**
 * It allocates the memory for the array and calls
 * roarm_moveit__srv__GetPoseCmd_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_roarm_moveit
...
/**
 * It calls
 * roarm_moveit__srv__GetPoseCmd_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROARM_MOVEIT__SRV__DETAIL__GET_POSE_CMD__FUNCTIONS_H_
