...
class Init_GetPoseCmd_Event_response
{
public:
  explicit Init_GetPoseCmd_Event_response(::roarm_moveit::srv::GetPoseCmd_Event & msg)
  : msg_(msg)
  {}
  ::roarm_moveit::srv::GetPoseCmd_Event response(::roarm_moveit::srv::GetPoseCmd_Event::_response_type arg)
  {
...
private:
  ::roarm_moveit::srv::GetPoseCmd_Event msg_;
};

class Init_GetPoseCmd_Event_request
{
public:
  explicit Init_GetPoseCmd_Event_request(::roarm_moveit::srv::GetPoseCmd_Event & msg)
  : msg_(msg)
  {}
  Init_GetPoseCmd_Event_response request(::roarm_moveit::srv::GetPoseCmd_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_GetPoseCmd_Event_response(msg_);
  }
...
class Init_GetPoseCmd_Event_info
{
public:
  Init_GetPoseCmd_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_GetPoseCmd_Event_request info(::roarm_moveit::srv::GetPoseCmd_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_GetPoseCmd_Event_request(msg_);
  }
...
template<>
inline
auto build<::roarm_moveit::srv::GetPoseCmd_Event>()
{
  return roarm_moveit::srv::builder::Init_GetPoseCmd_Event_info();
}
