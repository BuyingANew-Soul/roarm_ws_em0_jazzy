...
class Metaclass_MoveCircleCmd_Event(type):
    """Metaclass of message 'MoveCircleCmd_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__move_circle_cmd__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__move_circle_cmd__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__move_circle_cmd__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__move_circle_cmd__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__move_circle_cmd__event
...
class MoveCircleCmd_Event(metaclass=Metaclass_MoveCircleCmd_Event):
    """Message class 'MoveCircleCmd_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<roarm_moveit/MoveCircleCmd_Request, 1>',
        'response': 'sequence<roarm_moveit/MoveCircleCmd_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['roarm_moveit', 'srv'], 'MoveCircleCmd_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['roarm_moveit', 'srv'], 'MoveCircleCmd_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from roarm_moveit.srv import MoveCircleCmd_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, MoveCircleCmd_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'MoveCircleCmd_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from roarm_moveit.srv import MoveCircleCmd_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, MoveCircleCmd_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'MoveCircleCmd_Response'"
...
class Metaclass_MoveCircleCmd(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'roarm_moveit.srv.MoveCircleCmd')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from roarm_moveit.srv import _move_circle_cmd
            ...
            if _move_circle_cmd.Metaclass_MoveCircleCmd_Event._TYPE_SUPPORT is None:
                _move_circle_cmd.Metaclass_MoveCircleCmd_Event.__import_type_support__()


class MoveCircleCmd(metaclass=Metaclass_MoveCircleCmd):
    from roarm_moveit.srv._move_circle_cmd import MoveCircleCmd_Request as Request
    from roarm_moveit.srv._move_circle_cmd import MoveCircleCmd_Response as Response
    from roarm_moveit.srv._move_circle_cmd import MoveCircleCmd_Event as Event
