...
static const _MoveCircleCmd_Event_type_support_symbol_names_t _MoveCircleCmd_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, roarm_moveit, srv, MoveCircleCmd_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, roarm_moveit, srv, MoveCircleCmd_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, roarm_moveit, srv, MoveCircleCmd_Event)() {
  return &::roarm_moveit::srv::rosidl_typesupport_c::MoveCircleCmd_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t MoveCircleCmd_service_type_support_handle = {
  ...
  &MoveCircleCmd_Request_message_type_support_handle,
  &MoveCircleCmd_Response_message_type_support_handle,
  &MoveCircleCmd_Event_message_type_support_handle,
