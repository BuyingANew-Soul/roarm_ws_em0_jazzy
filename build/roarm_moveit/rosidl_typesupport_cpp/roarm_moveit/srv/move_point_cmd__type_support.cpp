...
static const _MovePointCmd_Event_type_support_symbol_names_t _MovePointCmd_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, roarm_moveit, srv, MovePointCmd_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, roarm_moveit, srv, MovePointCmd_Event)),
  }
};
...
{
  return &::roarm_moveit::srv::rosidl_typesupport_cpp::MovePointCmd_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, roarm_moveit, srv, MovePointCmd_Event)() {
  return get_message_type_support_handle<roarm_moveit::srv::MovePointCmd_Event>();
}
...
static const rosidl_service_type_support_t MovePointCmd_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<roarm_moveit::srv::MovePointCmd_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<roarm_moveit::srv::MovePointCmd_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<roarm_moveit::srv::MovePointCmd_Event>(),
