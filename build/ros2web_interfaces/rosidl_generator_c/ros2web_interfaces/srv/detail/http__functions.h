...
// IWYU pragma: private, include "ros2web_interfaces/srv/http.h"


#ifndef ROS2WEB_INTERFACES__SRV__DETAIL__HTTP__FUNCTIONS_H_
#define ROS2WEB_INTERFACES__SRV__DETAIL__HTTP__FUNCTIONS_H_
...
/// Create srv/HTTP message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ros2web_interfaces__srv__HTTP_Request__init().
...
/// Destroy srv/HTTP message.
/**
 * It calls
 * ros2web_interfaces__srv__HTTP_Request__fini()
...
/// Check for srv/HTTP message equality.
/**
...
/// Initialize array of srv/HTTP messages.
/**
...
/// Finalize array of srv/HTTP messages.
/**
 * It calls
 * ros2web_interfaces__srv__HTTP_Request__fini()
...
/// Create array of srv/HTTP messages.
/**
 * It allocates the memory for the array and calls
 * ros2web_interfaces__srv__HTTP_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/HTTP messages.
/**
 * It calls
 * ros2web_interfaces__srv__HTTP_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/HTTP message array equality.
/**
...
/// Copy an array of srv/HTTP messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ros2web_interfaces__srv__HTTP_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ros2web_interfaces
...
/**
 * It calls
 * ros2web_interfaces__srv__HTTP_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ros2web_interfaces
...
/**
 * It allocates the memory for the array and calls
 * ros2web_interfaces__srv__HTTP_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ros2web_interfaces
...
/**
 * It calls
 * ros2web_interfaces__srv__HTTP_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * ros2web_interfaces__srv__HTTP_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_ros2web_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ros2web_interfaces__srv__HTTP_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ros2web_interfaces
...
/**
 * It calls
 * ros2web_interfaces__srv__HTTP_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ros2web_interfaces
...
/**
 * It allocates the memory for the array and calls
 * ros2web_interfaces__srv__HTTP_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ros2web_interfaces
...
/**
 * It calls
 * ros2web_interfaces__srv__HTTP_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROS2WEB_INTERFACES__SRV__DETAIL__HTTP__FUNCTIONS_H_
