...
enum
{
  ros2web_interfaces__srv__HTTP_Event__request__MAX_SIZE = 1
};
// response
enum
{
  ros2web_interfaces__srv__HTTP_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/HTTP in the package ros2web_interfaces.
typedef struct ros2web_interfaces__srv__HTTP_Event
{
  service_msgs__msg__ServiceEventInfo info;
  ros2web_interfaces__srv__HTTP_Request__Sequence request;
  ros2web_interfaces__srv__HTTP_Response__Sequence response;
} ros2web_interfaces__srv__HTTP_Event;

// Struct for a sequence of ros2web_interfaces__srv__HTTP_Event.
typedef struct ros2web_interfaces__srv__HTTP_Event__Sequence
{
