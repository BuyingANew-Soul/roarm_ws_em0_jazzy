...
class Init_HTTP_Event_response
{
public:
  explicit Init_HTTP_Event_response(::ros2web_interfaces::srv::HTTP_Event & msg)
  : msg_(msg)
  {}
  ::ros2web_interfaces::srv::HTTP_Event response(::ros2web_interfaces::srv::HTTP_Event::_response_type arg)
  {
...
private:
  ::ros2web_interfaces::srv::HTTP_Event msg_;
};

class Init_HTTP_Event_request
{
public:
  explicit Init_HTTP_Event_request(::ros2web_interfaces::srv::HTTP_Event & msg)
  : msg_(msg)
  {}
  Init_HTTP_Event_response request(::ros2web_interfaces::srv::HTTP_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_HTTP_Event_response(msg_);
  }
...
class Init_HTTP_Event_info
{
public:
  Init_HTTP_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_HTTP_Event_request info(::ros2web_interfaces::srv::HTTP_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_HTTP_Event_request(msg_);
  }
...
template<>
inline
auto build<::ros2web_interfaces::srv::HTTP_Event>()
{
  return ros2web_interfaces::srv::builder::Init_HTTP_Event_info();
}
