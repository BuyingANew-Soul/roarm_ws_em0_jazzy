...
inline std::string to_yaml(const HTTP_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use ros2web_interfaces::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const ros2web_interfaces::srv::HTTP_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  ros2web_interfaces::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use ros2web_interfaces::srv::to_yaml() instead")]]
inline std::string to_yaml(const ros2web_interfaces::srv::HTTP_Event & msg)
{
  return ros2web_interfaces::srv::to_yaml(msg);
}

template<>
inline const char * data_type<ros2web_interfaces::srv::HTTP_Event>()
{
  return "ros2web_interfaces::srv::HTTP_Event";
}

template<>
inline const char * name<ros2web_interfaces::srv::HTTP_Event>()
{
  return "ros2web_interfaces/srv/HTTP_Event";
}

template<>
struct has_fixed_size<ros2web_interfaces::srv::HTTP_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<ros2web_interfaces::srv::HTTP_Event>
  : std::integral_constant<bool, has_bounded_size<ros2web_interfaces::srv::HTTP_Request>::value && has_bounded_size<ros2web_interfaces::srv::HTTP_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<ros2web_interfaces::srv::HTTP_Event>
  : std::true_type {};
