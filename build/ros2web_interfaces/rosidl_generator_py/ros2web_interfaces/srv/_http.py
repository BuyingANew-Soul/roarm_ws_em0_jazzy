...
class Metaclass_HTTP_Event(type):
    """Metaclass of message 'HTTP_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__http__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__http__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__http__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__http__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__http__event
...
class HTTP_Event(metaclass=Metaclass_HTTP_Event):
    """Message class 'HTTP_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<ros2web_interfaces/HTTP_Request, 1>',
        'response': 'sequence<ros2web_interfaces/HTTP_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ros2web_interfaces', 'srv'], 'HTTP_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ros2web_interfaces', 'srv'], 'HTTP_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from ros2web_interfaces.srv import HTTP_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, HTTP_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'HTTP_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from ros2web_interfaces.srv import HTTP_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, HTTP_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'HTTP_Response'"
...
class Metaclass_HTTP(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _http.Metaclass_HTTP_Event._TYPE_SUPPORT is None:
                _http.Metaclass_HTTP_Event.__import_type_support__()
...
class HTTP(metaclass=Metaclass_HTTP):
    ...
    from ros2web_interfaces.srv._http import HTTP_Event as Event
