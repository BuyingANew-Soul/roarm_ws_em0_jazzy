...
class Metaclass_WS_Event(type):
    """Metaclass of message 'WS_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__ws__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__ws__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__ws__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__ws__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__ws__event
...
class WS_Event(metaclass=Metaclass_WS_Event):
    """Message class 'WS_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<ros2web_interfaces/WS_Request, 1>',
        'response': 'sequence<ros2web_interfaces/WS_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ros2web_interfaces', 'srv'], 'WS_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ros2web_interfaces', 'srv'], 'WS_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from ros2web_interfaces.srv import WS_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, WS_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'WS_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from ros2web_interfaces.srv import WS_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, WS_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'WS_Response'"
...
class Metaclass_WS(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _ws.Metaclass_WS_Event._TYPE_SUPPORT is None:
                _ws.Metaclass_WS_Event.__import_type_support__()
...
class WS(metaclass=Metaclass_WS):
    ...
    from ros2web_interfaces.srv._ws import WS_Event as Event
