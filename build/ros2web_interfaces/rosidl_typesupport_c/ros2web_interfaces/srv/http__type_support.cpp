...
static const _HTTP_Request_type_support_symbol_names_t _HTTP_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2web_interfaces, srv, HTTP_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros2web_interfaces, srv, HTTP_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ros2web_interfaces, srv, HTTP_Request)() {
  return &::ros2web_interfaces::srv::rosidl_typesupport_c::HTTP_Request_message_type_support_handle;
}
...
static const _HTTP_Response_type_support_symbol_names_t _HTTP_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2web_interfaces, srv, HTTP_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros2web_interfaces, srv, HTTP_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ros2web_interfaces, srv, HTTP_Response)() {
  return &::ros2web_interfaces::srv::rosidl_typesupport_c::HTTP_Response_message_type_support_handle;
}
...
typedef struct _HTTP_Event_type_support_ids_t
{
  const char * typesupport_identifier[2];
} _HTTP_Event_type_support_ids_t;

static const _HTTP_Event_type_support_ids_t _HTTP_Event_message_typesupport_ids = {
  {
    "rosidl_typesupport_fastrtps_c",  // ::rosidl_typesupport_fastrtps_c::typesupport_identifier,
    "rosidl_typesupport_introspection_c",  // ::rosidl_typesupport_introspection_c::typesupport_identifier,
  }
...
typedef struct _HTTP_Event_type_support_symbol_names_t
{
  const char * symbol_name[2];
} _HTTP_Event_type_support_symbol_names_t;

#define STRINGIFY_(s) #s
#define STRINGIFY(s) STRINGIFY_(s)

static const _HTTP_Event_type_support_symbol_names_t _HTTP_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2web_interfaces, srv, HTTP_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros2web_interfaces, srv, HTTP_Event)),
  }
};

typedef struct _HTTP_Event_type_support_data_t
{
  void * data[2];
} _HTTP_Event_type_support_data_t;

static _HTTP_Event_type_support_data_t _HTTP_Event_message_typesupport_data = {
  {
    0,  // will store the shared library later
    0,  // will store the shared library later
  }
...
static const type_support_map_t _HTTP_Event_message_typesupport_map = {
  2,
  "ros2web_interfaces",
  &_HTTP_Event_message_typesupport_ids.typesupport_identifier[0],
  &_HTTP_Event_message_typesupport_symbol_names.symbol_name[0],
  &_HTTP_Event_message_typesupport_data.data[0],
};

static const rosidl_message_type_support_t HTTP_Event_message_type_support_handle = {
  rosidl_typesupport_c__typesupport_identifier,
  reinterpret_cast<const type_support_map_t *>(&_HTTP_Event_message_typesupport_map),
  rosidl_typesupport_c__get_message_typesupport_handle_function,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ros2web_interfaces, srv, HTTP_Event)() {
  return &::ros2web_interfaces::srv::rosidl_typesupport_c::HTTP_Event_message_type_support_handle;
}
...
static const _HTTP_type_support_symbol_names_t _HTTP_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2web_interfaces, srv, HTTP)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros2web_interfaces, srv, HTTP)),
  }
};
...
static const rosidl_service_type_support_t HTTP_service_type_support_handle = {
  ...
  &HTTP_Request_message_type_support_handle,
  &HTTP_Response_message_type_support_handle,
  &HTTP_Event_message_type_support_handle,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, ros2web_interfaces, srv, HTTP)() {
  return &::ros2web_interfaces::srv::rosidl_typesupport_c::HTTP_service_type_support_handle;
}
