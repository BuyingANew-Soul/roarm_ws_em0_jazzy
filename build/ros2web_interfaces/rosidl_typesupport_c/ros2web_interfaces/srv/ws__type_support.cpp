...
static const _WS_Event_type_support_symbol_names_t _WS_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2web_interfaces, srv, WS_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros2web_interfaces, srv, WS_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ros2web_interfaces, srv, WS_Event)() {
  return &::ros2web_interfaces::srv::rosidl_typesupport_c::WS_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t WS_service_type_support_handle = {
  ...
  &WS_Request_message_type_support_handle,
  &WS_Response_message_type_support_handle,
  &WS_Event_message_type_support_handle,
