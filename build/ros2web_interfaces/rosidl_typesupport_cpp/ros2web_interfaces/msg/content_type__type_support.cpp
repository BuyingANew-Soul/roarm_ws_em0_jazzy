...
static const _ContentType_type_support_symbol_names_t _ContentType_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2web_interfaces, msg, ContentType)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2web_interfaces, msg, ContentType)),
  }
};
...
{
  return &::ros2web_interfaces::msg::rosidl_typesupport_cpp::ContentType_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ros2web_interfaces, msg, ContentType)() {
  return get_message_type_support_handle<ros2web_interfaces::msg::ContentType>();
}
