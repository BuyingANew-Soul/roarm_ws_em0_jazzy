...
#include "ros2web_interfaces/msg/detail/body_part__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // content_type, filename, headers, name
#include "rosidl_runtime_c/string_functions.h"  // content_type, filename, headers, name

// forward declare type support functions


using _BodyPart__ros_msg_type = ros2web_interfaces__msg__BodyPart;
...
{
  const _BodyPart__ros_msg_type * ros_message = static_cast<const _BodyPart__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2web_interfaces__msg__BodyPart;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ros2web_interfaces__msg__BodyPart * ros_message = static_cast<const ros2web_interfaces__msg__BodyPart *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ros2web_interfaces__msg__BodyPart(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ros2web_interfaces__msg__BodyPart * ros_message = static_cast<ros2web_interfaces__msg__BodyPart *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ros2web_interfaces__msg__BodyPart(cdr, ros_message);
}

static uint32_t _BodyPart__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2web_interfaces__msg__BodyPart(
...
static size_t _BodyPart__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2web_interfaces__msg__BodyPart(
...
static message_type_support_callbacks_t __callbacks_BodyPart = {
...
static rosidl_message_type_support_t _BodyPart__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_BodyPart,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2web_interfaces, msg, BodyPart)() {
  return &_BodyPart__type_support;
}
