...
bool cdr_serialize_ros2web_interfaces__msg__HTTPStatusCode(
  const ros2web_interfaces__msg__HTTPStatusCode * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2web_interfaces
bool cdr_deserialize_ros2web_interfaces__msg__HTTPStatusCode(
  eprosima::fastcdr::Cdr & cdr,
  ros2web_interfaces__msg__HTTPStatusCode * ros_message)
{
  // Field name: structure_needs_at_least_one_member
  {
    cdr >> ros_message->structure_needs_at_least_one_member;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2web_interfaces
bool cdr_serialize_key_ros2web_interfaces__msg__HTTPStatusCode(
  const ros2web_interfaces__msg__HTTPStatusCode * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: structure_needs_at_least_one_member
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2web_interfaces
size_t get_serialized_size_key_ros2web_interfaces__msg__HTTPStatusCode(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _HTTPStatusCode__ros_msg_type * ros_message = static_cast<const _HTTPStatusCode__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2web_interfaces
size_t max_serialized_size_key_ros2web_interfaces__msg__HTTPStatusCode(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ros2web_interfaces__msg__HTTPStatusCode * ros_message = static_cast<const ros2web_interfaces__msg__HTTPStatusCode *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ros2web_interfaces__msg__HTTPStatusCode(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ros2web_interfaces__msg__HTTPStatusCode * ros_message = static_cast<ros2web_interfaces__msg__HTTPStatusCode *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ros2web_interfaces__msg__HTTPStatusCode(cdr, ros_message);
}
