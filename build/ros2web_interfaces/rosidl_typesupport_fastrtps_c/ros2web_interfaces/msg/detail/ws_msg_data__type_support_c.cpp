  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ros2web_interfaces__msg__WSMsgData * ros_message = static_cast<const ros2web_interfaces__msg__WSMsgData *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ros2web_interfaces__msg__WSMsgData(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ros2web_interfaces__msg__WSMsgData * ros_message = static_cast<ros2web_interfaces__msg__WSMsgData *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ros2web_interfaces__msg__WSMsgData(cdr, ros_message);
}
