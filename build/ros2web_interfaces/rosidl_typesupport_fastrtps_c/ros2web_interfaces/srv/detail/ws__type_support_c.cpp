...
bool cdr_serialize_ros2web_interfaces__msg__WSMsgData(
  const ros2web_interfaces__msg__WSMsgData * ros_message,
  eprosima::fastcdr::Cdr & cdr);

bool cdr_deserialize_ros2web_interfaces__msg__WSMsgData(
  eprosima::fastcdr::Cdr & cdr,
  ros2web_interfaces__msg__WSMsgData * ros_message);
...
bool cdr_serialize_key_ros2web_interfaces__msg__WSMsgData(
  const ros2web_interfaces__msg__WSMsgData * ros_message,
  eprosima::fastcdr::Cdr & cdr);

size_t get_serialized_size_key_ros2web_interfaces__msg__WSMsgData(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_key_ros2web_interfaces__msg__WSMsgData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
...
bool cdr_serialize_ros2web_interfaces__srv__WS_Request(
  const ros2web_interfaces__srv__WS_Request * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: srv_name
  {
  ...
  // Field name: data
  {
    cdr_serialize_ros2web_interfaces__msg__WSMsgData(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2web_interfaces
bool cdr_deserialize_ros2web_interfaces__srv__WS_Request(
  eprosima::fastcdr::Cdr & cdr,
  ros2web_interfaces__srv__WS_Request * ros_message)
{
  // Field name: srv_name
  {
    std::string tmp;
  ...
  // Field name: data
  {
    cdr_deserialize_ros2web_interfaces__msg__WSMsgData(cdr, &ros_message->data);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2web_interfaces
bool cdr_serialize_key_ros2web_interfaces__srv__WS_Request(
  const ros2web_interfaces__srv__WS_Request * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: srv_name
  ...
  // Field name: data
  {
    cdr_serialize_key_ros2web_interfaces__msg__WSMsgData(
      &ros_message->data, cdr);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2web_interfaces
size_t get_serialized_size_key_ros2web_interfaces__srv__WS_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _WS_Request__ros_msg_type * ros_message = static_cast<const _WS_Request__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: data
  current_alignment += get_serialized_size_key_ros2web_interfaces__msg__WSMsgData(
    &(ros_message->data), current_alignment);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2web_interfaces
size_t max_serialized_size_key_ros2web_interfaces__srv__WS_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: data
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_ros2web_interfaces__msg__WSMsgData(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ros2web_interfaces__srv__WS_Request * ros_message = static_cast<const ros2web_interfaces__srv__WS_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ros2web_interfaces__srv__WS_Request(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ros2web_interfaces__srv__WS_Request * ros_message = static_cast<ros2web_interfaces__srv__WS_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ros2web_interfaces__srv__WS_Request(cdr, ros_message);
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2web_interfaces
bool cdr_serialize_ros2web_interfaces__srv__WS_Response(
  const ros2web_interfaces__srv__WS_Response * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: type
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2web_interfaces
bool cdr_deserialize_ros2web_interfaces__srv__WS_Response(
  eprosima::fastcdr::Cdr & cdr,
  ros2web_interfaces__srv__WS_Response * ros_message)
{
  // Field name: type
  {
    cdr >> ros_message->type;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2web_interfaces
bool cdr_serialize_key_ros2web_interfaces__srv__WS_Response(
  const ros2web_interfaces__srv__WS_Response * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: type
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2web_interfaces
size_t get_serialized_size_key_ros2web_interfaces__srv__WS_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _WS_Response__ros_msg_type * ros_message = static_cast<const _WS_Response__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2web_interfaces
size_t max_serialized_size_key_ros2web_interfaces__srv__WS_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ros2web_interfaces__srv__WS_Response * ros_message = static_cast<const ros2web_interfaces__srv__WS_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ros2web_interfaces__srv__WS_Response(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ros2web_interfaces__srv__WS_Response * ros_message = static_cast<ros2web_interfaces__srv__WS_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ros2web_interfaces__srv__WS_Response(cdr, ros_message);
}
...
using _WS_Event__ros_msg_type = ros2web_interfaces__srv__WS_Event;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2web_interfaces
bool cdr_serialize_ros2web_interfaces__srv__WS_Event(
  const ros2web_interfaces__srv__WS_Event * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: info
  {
  ...
  // Field name: request
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_ros2web_interfaces__srv__WS_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_ros2web_interfaces__srv__WS_Response(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2web_interfaces
bool cdr_deserialize_ros2web_interfaces__srv__WS_Event(
  eprosima::fastcdr::Cdr & cdr,
  ros2web_interfaces__srv__WS_Event * ros_message)
{
  // Field name: info
  {
  ...
  // Field name: request
  {
    ...
    if (ros_message->request.data) {
      ros2web_interfaces__srv__WS_Request__Sequence__fini(&ros_message->request);
    }
    ...
    auto array_ptr = ros_message->request.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_ros2web_interfaces__srv__WS_Request(cdr, &array_ptr[i]);
    }
  }
  ...
  // Field name: response
  {
    ...
    if (ros_message->response.data) {
      ros2web_interfaces__srv__WS_Response__Sequence__fini(&ros_message->response);
    }
    ...
    auto array_ptr = ros_message->response.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_ros2web_interfaces__srv__WS_Response(cdr, &array_ptr[i]);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2web_interfaces
size_t get_serialized_size_ros2web_interfaces__srv__WS_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _WS_Event__ros_msg_type * ros_message = static_cast<const _WS_Event__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  size_t initial_alignment = current_alignment;
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_ros2web_interfaces__srv__WS_Request(
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_ros2web_interfaces__srv__WS_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2web_interfaces
size_t max_serialized_size_ros2web_interfaces__srv__WS_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_ros2web_interfaces__srv__WS_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_ros2web_interfaces__srv__WS_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros2web_interfaces__srv__WS_Event;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2web_interfaces
bool cdr_serialize_key_ros2web_interfaces__srv__WS_Event(
  const ros2web_interfaces__srv__WS_Event * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: info
  ...
  // Field name: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_ros2web_interfaces__srv__WS_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_ros2web_interfaces__srv__WS_Response(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2web_interfaces
size_t get_serialized_size_key_ros2web_interfaces__srv__WS_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _WS_Event__ros_msg_type * ros_message = static_cast<const _WS_Event__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_ros2web_interfaces__srv__WS_Request(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_ros2web_interfaces__srv__WS_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2web_interfaces
size_t max_serialized_size_key_ros2web_interfaces__srv__WS_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_ros2web_interfaces__srv__WS_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_ros2web_interfaces__srv__WS_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ros2web_interfaces__srv__WS_Event * ros_message = static_cast<const ros2web_interfaces__srv__WS_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ros2web_interfaces__srv__WS_Event(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ros2web_interfaces__srv__WS_Event * ros_message = static_cast<ros2web_interfaces__srv__WS_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ros2web_interfaces__srv__WS_Event(cdr, ros_message);
}

static uint32_t _WS_Event__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2web_interfaces__srv__WS_Event(
      untyped_ros_message, 0));
}
...
static size_t _WS_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2web_interfaces__srv__WS_Event(
    full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t __callbacks_WS_Event = {
  "ros2web_interfaces::srv",
  "WS_Event",
...
static rosidl_message_type_support_t _WS_Event__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_WS_Event,
  get_message_typesupport_handle_function,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2web_interfaces, srv, WS_Event)() {
  return &_WS_Event__type_support;
}
...
static rosidl_service_type_support_t WS__handle = {
  ...
  &_WS_Request__type_support,
  &_WS_Response__type_support,
  &_WS_Event__type_support,
