...
void ros2web_interfaces__srv__HTTP_Event__rosidl_typesupport_introspection_c__HTTP_Event_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  ros2web_interfaces__srv__HTTP_Event__init(message_memory);
}

void ros2web_interfaces__srv__HTTP_Event__rosidl_typesupport_introspection_c__HTTP_Event_fini_function(void * message_memory)
{
  ros2web_interfaces__srv__HTTP_Event__fini(message_memory);
}

size_t ros2web_interfaces__srv__HTTP_Event__rosidl_typesupport_introspection_c__size_function__HTTP_Event__request(
  const void * untyped_member)
{
  const ros2web_interfaces__srv__HTTP_Request__Sequence * member =
    (const ros2web_interfaces__srv__HTTP_Request__Sequence *)(untyped_member);
  return member->size;
}

const void * ros2web_interfaces__srv__HTTP_Event__rosidl_typesupport_introspection_c__get_const_function__HTTP_Event__request(
  const void * untyped_member, size_t index)
{
  const ros2web_interfaces__srv__HTTP_Request__Sequence * member =
    (const ros2web_interfaces__srv__HTTP_Request__Sequence *)(untyped_member);
...
void * ros2web_interfaces__srv__HTTP_Event__rosidl_typesupport_introspection_c__get_function__HTTP_Event__request(
  void * untyped_member, size_t index)
{
  ros2web_interfaces__srv__HTTP_Request__Sequence * member =
    (ros2web_interfaces__srv__HTTP_Request__Sequence *)(untyped_member);
  return &member->data[index];
}

void ros2web_interfaces__srv__HTTP_Event__rosidl_typesupport_introspection_c__fetch_function__HTTP_Event__request(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const ros2web_interfaces__srv__HTTP_Request * item =
    ((const ros2web_interfaces__srv__HTTP_Request *)
    ros2web_interfaces__srv__HTTP_Event__rosidl_typesupport_introspection_c__get_const_function__HTTP_Event__request(untyped_member, index));
  ros2web_interfaces__srv__HTTP_Request * value =
    (ros2web_interfaces__srv__HTTP_Request *)(untyped_value);
  *value = *item;
}

void ros2web_interfaces__srv__HTTP_Event__rosidl_typesupport_introspection_c__assign_function__HTTP_Event__request(
  void * untyped_member, size_t index, const void * untyped_value)
{
  ros2web_interfaces__srv__HTTP_Request * item =
    ((ros2web_interfaces__srv__HTTP_Request *)
    ros2web_interfaces__srv__HTTP_Event__rosidl_typesupport_introspection_c__get_function__HTTP_Event__request(untyped_member, index));
  const ros2web_interfaces__srv__HTTP_Request * value =
    (const ros2web_interfaces__srv__HTTP_Request *)(untyped_value);
  *item = *value;
}

bool ros2web_interfaces__srv__HTTP_Event__rosidl_typesupport_introspection_c__resize_function__HTTP_Event__request(
  void * untyped_member, size_t size)
{
  ros2web_interfaces__srv__HTTP_Request__Sequence * member =
    (ros2web_interfaces__srv__HTTP_Request__Sequence *)(untyped_member);
  ros2web_interfaces__srv__HTTP_Request__Sequence__fini(member);
  return ros2web_interfaces__srv__HTTP_Request__Sequence__init(member, size);
}

size_t ros2web_interfaces__srv__HTTP_Event__rosidl_typesupport_introspection_c__size_function__HTTP_Event__response(
  const void * untyped_member)
{
  const ros2web_interfaces__srv__HTTP_Response__Sequence * member =
    (const ros2web_interfaces__srv__HTTP_Response__Sequence *)(untyped_member);
  return member->size;
}

const void * ros2web_interfaces__srv__HTTP_Event__rosidl_typesupport_introspection_c__get_const_function__HTTP_Event__response(
  const void * untyped_member, size_t index)
{
  const ros2web_interfaces__srv__HTTP_Response__Sequence * member =
    (const ros2web_interfaces__srv__HTTP_Response__Sequence *)(untyped_member);
...
void * ros2web_interfaces__srv__HTTP_Event__rosidl_typesupport_introspection_c__get_function__HTTP_Event__response(
  void * untyped_member, size_t index)
{
  ros2web_interfaces__srv__HTTP_Response__Sequence * member =
    (ros2web_interfaces__srv__HTTP_Response__Sequence *)(untyped_member);
  return &member->data[index];
}

void ros2web_interfaces__srv__HTTP_Event__rosidl_typesupport_introspection_c__fetch_function__HTTP_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const ros2web_interfaces__srv__HTTP_Response * item =
    ((const ros2web_interfaces__srv__HTTP_Response *)
    ros2web_interfaces__srv__HTTP_Event__rosidl_typesupport_introspection_c__get_const_function__HTTP_Event__response(untyped_member, index));
  ros2web_interfaces__srv__HTTP_Response * value =
    (ros2web_interfaces__srv__HTTP_Response *)(untyped_value);
  *value = *item;
}

void ros2web_interfaces__srv__HTTP_Event__rosidl_typesupport_introspection_c__assign_function__HTTP_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  ros2web_interfaces__srv__HTTP_Response * item =
    ((ros2web_interfaces__srv__HTTP_Response *)
    ros2web_interfaces__srv__HTTP_Event__rosidl_typesupport_introspection_c__get_function__HTTP_Event__response(untyped_member, index));
  const ros2web_interfaces__srv__HTTP_Response * value =
    (const ros2web_interfaces__srv__HTTP_Response *)(untyped_value);
  *item = *value;
}

bool ros2web_interfaces__srv__HTTP_Event__rosidl_typesupport_introspection_c__resize_function__HTTP_Event__response(
  void * untyped_member, size_t size)
{
  ros2web_interfaces__srv__HTTP_Response__Sequence * member =
    (ros2web_interfaces__srv__HTTP_Response__Sequence *)(untyped_member);
  ros2web_interfaces__srv__HTTP_Response__Sequence__fini(member);
  return ros2web_interfaces__srv__HTTP_Response__Sequence__init(member, size);
}

static rosidl_typesupport_introspection_c__MessageMember ros2web_interfaces__srv__HTTP_Event__rosidl_typesupport_introspection_c__HTTP_Event_message_member_array[3] = {
  {
    "info",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2web_interfaces__srv__HTTP_Event, info),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(ros2web_interfaces__srv__HTTP_Event, request),  // bytes offset in struct
    NULL,  // default value
    ros2web_interfaces__srv__HTTP_Event__rosidl_typesupport_introspection_c__size_function__HTTP_Event__request,  // size() function pointer
    ros2web_interfaces__srv__HTTP_Event__rosidl_typesupport_introspection_c__get_const_function__HTTP_Event__request,  // get_const(index) function pointer
    ros2web_interfaces__srv__HTTP_Event__rosidl_typesupport_introspection_c__get_function__HTTP_Event__request,  // get(index) function pointer
    ros2web_interfaces__srv__HTTP_Event__rosidl_typesupport_introspection_c__fetch_function__HTTP_Event__request,  // fetch(index, &value) function pointer
    ros2web_interfaces__srv__HTTP_Event__rosidl_typesupport_introspection_c__assign_function__HTTP_Event__request,  // assign(index, value) function pointer
    ros2web_interfaces__srv__HTTP_Event__rosidl_typesupport_introspection_c__resize_function__HTTP_Event__request  // resize(index) function pointer
  },
  {
    "response",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(ros2web_interfaces__srv__HTTP_Event, response),  // bytes offset in struct
    NULL,  // default value
    ros2web_interfaces__srv__HTTP_Event__rosidl_typesupport_introspection_c__size_function__HTTP_Event__response,  // size() function pointer
    ros2web_interfaces__srv__HTTP_Event__rosidl_typesupport_introspection_c__get_const_function__HTTP_Event__response,  // get_const(index) function pointer
    ros2web_interfaces__srv__HTTP_Event__rosidl_typesupport_introspection_c__get_function__HTTP_Event__response,  // get(index) function pointer
    ros2web_interfaces__srv__HTTP_Event__rosidl_typesupport_introspection_c__fetch_function__HTTP_Event__response,  // fetch(index, &value) function pointer
    ros2web_interfaces__srv__HTTP_Event__rosidl_typesupport_introspection_c__assign_function__HTTP_Event__response,  // assign(index, value) function pointer
    ros2web_interfaces__srv__HTTP_Event__rosidl_typesupport_introspection_c__resize_function__HTTP_Event__response  // resize(index) function pointer
  }
};

static const rosidl_typesupport_introspection_c__MessageMembers ros2web_interfaces__srv__HTTP_Event__rosidl_typesupport_introspection_c__HTTP_Event_message_members = {
  "ros2web_interfaces__srv",  // message namespace
  "HTTP_Event",  // message name
  3,  // number of fields
  sizeof(ros2web_interfaces__srv__HTTP_Event),
  false,  // has_any_key_member_
  ros2web_interfaces__srv__HTTP_Event__rosidl_typesupport_introspection_c__HTTP_Event_message_member_array,  // message members
  ros2web_interfaces__srv__HTTP_Event__rosidl_typesupport_introspection_c__HTTP_Event_init_function,  // function to initialize message memory (memory has to be allocated)
  ros2web_interfaces__srv__HTTP_Event__rosidl_typesupport_introspection_c__HTTP_Event_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t ros2web_interfaces__srv__HTTP_Event__rosidl_typesupport_introspection_c__HTTP_Event_message_type_support_handle = {
  0,
  &ros2web_interfaces__srv__HTTP_Event__rosidl_typesupport_introspection_c__HTTP_Event_message_members,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_ros2web_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros2web_interfaces, srv, HTTP_Event)() {
  ros2web_interfaces__srv__HTTP_Event__rosidl_typesupport_introspection_c__HTTP_Event_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, service_msgs, msg, ServiceEventInfo)();
  ros2web_interfaces__srv__HTTP_Event__rosidl_typesupport_introspection_c__HTTP_Event_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros2web_interfaces, srv, HTTP_Request)();
  ros2web_interfaces__srv__HTTP_Event__rosidl_typesupport_introspection_c__HTTP_Event_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros2web_interfaces, srv, HTTP_Response)();
  if (!ros2web_interfaces__srv__HTTP_Event__rosidl_typesupport_introspection_c__HTTP_Event_message_type_support_handle.typesupport_identifier) {
    ros2web_interfaces__srv__HTTP_Event__rosidl_typesupport_introspection_c__HTTP_Event_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &ros2web_interfaces__srv__HTTP_Event__rosidl_typesupport_introspection_c__HTTP_Event_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
static rosidl_service_type_support_t ros2web_interfaces__srv__detail__http__rosidl_typesupport_introspection_c__HTTP_service_type_support_handle = {
  ...
  &ros2web_interfaces__srv__HTTP_Request__rosidl_typesupport_introspection_c__HTTP_Request_message_type_support_handle,
  &ros2web_interfaces__srv__HTTP_Response__rosidl_typesupport_introspection_c__HTTP_Response_message_type_support_handle,
  &ros2web_interfaces__srv__HTTP_Event__rosidl_typesupport_introspection_c__HTTP_Event_message_type_support_handle,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros2web_interfaces, srv, HTTP_Request)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros2web_interfaces, srv, HTTP_Response)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros2web_interfaces, srv, HTTP_Event)(void);

ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_ros2web_interfaces
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros2web_interfaces, srv, HTTP)(void) {
  ...
  if (!service_members->event_members_) {
    service_members->event_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros2web_interfaces, srv, HTTP_Event)()->data;
  }
